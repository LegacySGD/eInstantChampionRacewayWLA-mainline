...
public class ChampionRacewayWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(ChampionRacewayWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/DerbyRunWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/DerbyRunWLAIW/InitOutcome.xml").getDocumentElement();
